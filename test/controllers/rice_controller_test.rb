...
class RiceControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rice" do
    assert_difference("Rice.count") do
      post rice_index_url, params: { rice: { bidding_price: @rice.bidding_price, name: @rice.name } }
    end
  ...
  test "should update rice" do
    patch rice_url(@rice), params: { rice: { bidding_price: @rice.bidding_price, name: @rice.name } }
